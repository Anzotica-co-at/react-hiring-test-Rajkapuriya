        ...
        {hotels.map((hotel, index) => {
          ...
          return (
            <SwiperSlide
              ...
              } py-8 md:py-16 px-4 md:px-6 !w-full md:!w-[55%]`}
            >
              <div className="h-full relative">
                <motion.div
                  ...
                  className="shadow-md flex justify-center items-center h-[300px] md:h-[400px]"
                >
                  <img
                    src={hotel.image}
                    alt={hotel.name}
                ...
                <AnimatePresence mode="wait">
                  {isActive && (
                    <motion.div
                      ...
                      } md:-right-16 max-md:bottom-0 max-md:left-0 max-md:right-0 max-md:top-auto w-[80%] md:max-w-sm max-md:w-full border-2 border-[#8B6A29] shadow-lg md:p-2 p-1`}
                    >
                      <div className="text-center w-full flex gap-2 flex-col items-center justify-center text-black h-full bg-zinc-100 md:p-6 p-4 max-w-md max-md:max-w-none">
                        <p className="text-[10px] md:text-[10px] text-xs uppercase tracking-widest">
                          Now Open
                        </p>
                        <h3 className="text-lg md:text-xl font-serif w-full">
                          {hotel.name}
                        </h3>
                        <p className="text-xs md:text-sm leading-relaxed max-md:line-clamp-2">
                          {hotel.description}
                        </p>
                        <button className="cursor-pointer font-semibold border-b-2 border-black transition pt-2 text-sm md:text-base">
                          Explore More
                        </button>
                      </div>
                    </motion.div>
